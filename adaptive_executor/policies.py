    ...
    def target_workers(self) -> int:
        ...
        try:
            ...
            for criterion in self.criteria:
                try:
                    ...
                    logger.debug(
                        ...
                        criterion.__class__.__name__, limit
                    )
                except Exception as e:
                    logger.error(
                        "Error getting worker limit from %s: %s",
                        criterion.__class__.__name__, str(e), exc_info=True
                    )
            ...
            logger.debug(
                ...
                min_limit, self.hard_cap, result
            )
            ...
            logger.error(
                "Error calculating target workers: %s",
                str(e), exc_info=True
            )
