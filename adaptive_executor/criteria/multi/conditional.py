...
class ConditionalCriterion(ScalingCriterion):
    ...
    def __init__(
        self,
        condition_criterion: ScalingCriterion,
        action_criterion: ScalingCriterion,
        workers: int,
    ):
    ...
    def max_workers(self) -> int:
        ...
        try:
            ...
            logger.error(
                "Error in ConditionalCriterion.max_workers: %s", str(e), exc_info=True
            )
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ConditionalCriterion":
        ...
        try:
            ...
            logger.error(
                "Missing required key in ConditionalCriterion data: %s", str(e)
            )
            raise
        except Exception as e:
            logger.error(
                "Error creating ConditionalCriterion from dict: %s",
                str(e),
                exc_info=True,
            )
            raise
