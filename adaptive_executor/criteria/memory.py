...
class MemoryCriterion(ScalingCriterion):
    ...
    def max_workers(self) -> int:
        ...
        try:
            ...
            logger.error(
                "Error in MemoryCriterion.max_workers: %s", str(e), exc_info=True
            )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Error serializing MemoryCriterion to dict: %s", str(e), exc_info=True
            )
            raise
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "MemoryCriterion":
        ...
        try:
            ...
            logger.error(
                "Error creating MemoryCriterion from dict: %s", str(e), exc_info=True
            )
            raise
